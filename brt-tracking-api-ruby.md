...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    begin
      params  = [{"tracking_number" => "249022794942201","courier_code"=>"bartolini"},{"tracking_number" => "089191803516765","courier_code"=>"bartolini"}]
...
Get status of the shipment:
    ...
    begin
      ...
      # params  = {"tracking_numbers" => "249022794942201,089191803516765","courier_code"=>"bartolini"}
