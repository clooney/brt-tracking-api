BRT Tracking API - Java
================================
Use Java to track BRT shipments with BRT Tracking API.
...
Create a tracking (Real-time tracking):
    ...
    package com.trackingmore.example.bartolini;
    ...
    public class CreateBRTTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams.setTrackingNumber("116031020229566");
                createTrackingParams.setCourierCode("bartolini");
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    public class CreateBRTTrackingsExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams1.setTrackingNumber("249022794942201");
                createTrackingParams1.setCourierCode("bartolini");
                
                CreateTrackingParams createTrackingParams2 = new CreateTrackingParams();
                createTrackingParams2.setTrackingNumber("089191803516765");
                createTrackingParams2.setCourierCode("bartolini");
...
Get status of the shipment:
    ...
    public class GetBRTTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                # trackingParams.setTrackingNumbers("249022794942201,089191803516765");
                trackingParams.setCourierCode("bartolini");
...
Update a tracking by ID:
    ...
    public class UpdateBRTTrackingExample {
